...
<?php endif; ?>
    ...
    <table class="mt-2 border-4 border-black">
        ...
        <tbody class="border-2 border-black">
            ...
            <?php if($carbrand->id == $carmodel->car_brand_id): ?>


            <tr class="border-2 border-black ">
                <td class="border-2 border-black"><?php echo e($carmodel->id); ?></td>
                <td class="border-2 border-black"><?php echo e($carbrand->brand_name); ?></td>
                <td class="border-2 border-black"><?php echo e($carmodel->model_name); ?></td>
                <td class="border-2 border-black"><?php echo e($carmodel->created_at); ?></td>
                <td class="border-2 border-black"> <?php echo e($carmodel->updated_at); ?></td>
                <td class="border-2 border-black"> <?php echo e($carmodel->status_label); ?></td>
                <td class="border-2 border-black"> <?php echo e($carmodel->createdby->name); ?></td>

                <td>
                    <a href="/carmodels/edit/<?php echo e($carmodel->id); ?>">Редактиране </a>
                </td>
...
<?php endif; ?><?php /**PATH C:\auto-trader\resources\views/carmodels/index.blade.php ENDPATH**/ ?>