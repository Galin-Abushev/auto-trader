        ...
        <div class="borderBox grid bg-slate-100  sm:grid-cols-12  mt-2 rounded-sm   col-span-12 h-[40px]">
            ...
            <div class=" rounded-sm  col-span-6  h-[40px] gap-1">
                <div class="flex items-center sm:grid-cols-12">
                    ...
                    <div>
                        <div class="grid col-span-12 mt-2 ml-4 font-bold text-m "><?php echo e($car->car_km); ?> .км
                        </div>
        ...
        <div class="grid  sm:grid-cols-12  rounded-sm    col-span-12 h-[40px]">
            ...
            <div class=" rounded-sm  col-span-6  h-[40px] gap-1">
                <div class="flex items-center sm:grid-cols-12">
                    ...
                    <div>
                        <div class="grid col-span-12 mt-2 ml-4 font-bold text-m "><?php echo e($car->carEngine->engine_name); ?>
        ...
        <div class="borderBox grid bg-slate-100  sm:grid-cols-12  mt-2 rounded-sm   col-span-12 h-[40px]">
            ...
            <div class=" rounded-sm  col-span-6  h-[40px] gap-1">
                <div class="flex items-center sm:grid-cols-12">
                    ...
                    <div>
                        <div class="grid col-span-12 mt-2 ml-4 font-bold text-m "><?php echo e($car->car_hp); ?> .кс
                        </div>
        ...
        <div class="borderBox grid bg-slate-100  sm:grid-cols-12  mt-2 rounded-sm   col-span-12 h-[40px]">
            ...
            <div class=" rounded-sm  col-span-6  h-[40px] gap-1">
                <div class="flex items-center sm:grid-cols-12">
                    ...
                    <div>
                        <div class="grid col-span-12 mt-2 ml-4 font-bold text-m "><?php echo e($car->car_version); ?>
...
</div><?php /**PATH C:\auto-trader\resources\views/components/show/techdata.blade.php ENDPATH**/ ?>