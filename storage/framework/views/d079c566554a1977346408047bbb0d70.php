...
'id' => $name,
'name' => $name,
'class' => 'rounded-xl bg-blue-200 border border-black px-5 py-4 w-full',
'value' => old($name)
];
?>
...
<?php endif; ?><?php /**PATH C:\auto-trader\resources\views/components/forms/input.blade.php ENDPATH**/ ?>