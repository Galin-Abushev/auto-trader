...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>Редакция на характеристика: <?php echo e($data->equipment_name); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
    ...
    <form class="max-w-2xl mx-auto space-y-6" method="POST" action="/carequipments/<?php echo e($data->id); ?>">
        <?php echo csrf_field(); ?>
        <?php echo method_field('PATCH'); ?>
        <?php if (isset($component)) { $__componentOriginal4fb6044c7ed6b655352043ff774efcd0 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal4fb6044c7ed6b655352043ff774efcd0 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.forms.input','data' => ['value' => ''.e($data->equipment_name).'','label' => 'Характеристика','name' => 'equipment_name']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['value' => ''.e($data->equipment_name).'','label' => 'Характеристика','name' => 'equipment_name']); ?>
...
<?php endif; ?>
    ...
    <form method="POST" action="/carequipments/<?php echo e($data->id); ?>" id="form-delete" class="hiden">
        <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\auto-trader\resources\views/carequipments/edit.blade.php ENDPATH**/ ?>