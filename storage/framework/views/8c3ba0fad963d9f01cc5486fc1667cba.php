...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>Редакция на снимките на автомобил: <?php echo e($data->carbrand->brand_name); ?> - <?php echo e($data->carmodel->model_name); ?>
...
<?php endif; ?>
    ...
    <form class="max-w-2xl mx-auto space-y-6" method="POST" action="/admincars/photos/edit/<?php echo e($data->id); ?> "
        ...
        <?php echo csrf_field(); ?>
        <div>
            <label>Качете снимки (максимум <?php echo e($alabala->maxPhotos); ?> снимки)</label>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'text-white']); ?>Качи снимките <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
        ...
        <div class="flex gap-1 mt-1 thumbnail-photos">
            ...
            <div class="w-32 h-20">
                ...
                <div>
                    <a href="/admincars/photos/delete/<?php echo e($photo->id); ?>">Изтрий</a>
                </div>
            </div>
...
<?php endif; ?><?php /**PATH C:\auto-trader\resources\views/car-photo/index.blade.php ENDPATH**/ ?>